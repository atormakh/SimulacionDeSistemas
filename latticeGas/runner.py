...
def run(N = 2000, hole_size=50, seed = 0, avg_grid = 10, avg_t=10):
    ...
    proc = os.popen(f"java -cp ../../target/latticeGas-1.0-SNAPSHOT.jar -DnumParticles={N} -DholeSize={hole_size} -Dseed={seed} latticeGas.Main")
    print(proc.readline())
...
if __name__ == "__main__":
    ...
    parser.add_argument("-w", "--holeSize", type=int, default=50, help="Hole size")
    args = parser.parse_args()
    run(args.numParticles, args.holeSize, args.seed, args.avgGrid, args.avgT)
