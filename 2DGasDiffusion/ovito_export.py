...
def generate_wall(width=0.24, height=0.09, hole_size=0.03): 
    ...
    with open(filename, "w") as f:
        ...
        for j in range(0, hole_n):
            ...
            f.write("{} {} {} {}\n".format(MULTIPLIER*i, MULTIPLIER*j, hole_diameter*MULTIPLIER/2, 255, 0, 0))
            j=-idx*wall_diameter + height/2 - hole_size/2 - hole_diameter/2
            f.write("{} {} {} {}\n".format(MULTIPLIER*i, MULTIPLIER*j, hole_diameter*MULTIPLIER/2, 255, 0, 0))
        ...
        for i in range(width_n):
            ...
            j = -width_diameter/2
            f.write("{} {} {} {}\n".format(MULTIPLIER*i, MULTIPLIER*j, width_diameter*MULTIPLIER/2, 255, 0, 0))
        ...
        for j in range(height_n):
            ...
            f.write("{} {} {} {}\n".format(MULTIPLIER*i, MULTIPLIER*j, height_diameter*MULTIPLIER/2, 255, 0, 0))
